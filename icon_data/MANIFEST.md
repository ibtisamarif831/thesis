...
| 13 | `13_usp_pictograms_manual/` | `https://www.usp.org/health-quality-safety/usp-pictograms` | Medication-instruction pictograms for patient communication and health literacy. Potentially useful, but files require manual license acceptance. | Source not mirrored; local folder contains only README/licensing notes because USP requires accepting a license agreement before downloading 81 GIF/EPS pictograms | No local icon media until manual licensed download | 0 |
