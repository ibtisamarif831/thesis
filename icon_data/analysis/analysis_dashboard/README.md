...
- a compact cluster-analysis section with **Show heatmap** and **View all cluster details**;
- fullscreen heatmap or all-cluster views; the all-details modal starts every cluster expanded and includes its complete currently filtered icon list.
