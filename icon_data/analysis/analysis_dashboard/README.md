...
- **AI Clustering** for explicit OpenRouter image embeddings, interactive AI-cluster inspection, actual embedding and post-hoc measured-feature cluster contributions, descriptive labels/heatmaps, per-cluster icon and feature statistics, fullscreen galleries, a button-triggered comparison modal, and saved run loading.
