...
- https://github.com/blissymbolics/blissymbols
...
- All 5,825 canonical rendered SVG rows were normalized to 256px PNGs under `icon_data/normalized_256/06_blissymbolics/` with zero failures.

Verified local rendered counts:

- 1,150 character SVGs
- 4,675 word SVGs
- 5,825 total rendered SVGs
- 5,825 normalized PNGs
