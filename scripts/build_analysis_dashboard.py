...
<body>
  ...
  <main>
    <aside>
      ...
      <section class="control">
        ...
        <label>Style<select id="styleFilter"><option value="">All styles</option></select></label>
      </section>
    </aside>
  ...
  <script>
    ...
    function initializeControls() {{
      ...
      fillSelect("categoryFilter", [["", "All categories"], ...categories.map(v => [v, v])], "");
      fillSelect("styleFilter", [["", "All styles"], ...styles.map(v => [v, v])], "");
      ...
      document.getElementById("categoryFilter").addEventListener("change", e => {{ state.categoryFilter = e.target.value; render(); }});
      document.getElementById("styleFilter").addEventListener("change", e => {{ state.styleFilter = e.target.value; render(); }});
    ...
    function passesFilters(record) {{
      ...
      if (state.categoryFilter && record.category !== state.categoryFilter) return false;
      if (state.styleFilter && record.style_label !== state.styleFilter) return false;
      return true;
    }}
